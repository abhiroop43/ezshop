...
internal class InitialData
{
    ...
    {
        Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "Nikki", "nikki@gmail.com"),
        Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "Daphne", "daphne@gmail.com")
    };
    ...
    public static IEnumerable<Domain.Models.Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("Lily", "Monroe", "lily.monroe@gmail.com", "Transversal No:4", "Colombia", "Bogota", "38050");
            var address2 = Address.Of("Bella", "Foxx", "bella.foxx@gmail.com", "Broadway No:1", "England", "London", "08050");
